        ...
        <section class="sec2">
            ...
            <div class="create-account">
                ...
                <form action="" method="post">
                    ...
                    <button class="button" name="submit" value="login now">Create Account</button>
                </form>
            </div>
            <div class="text2 login">Don't have an account? <a href="signup.php" class="link ms-1 text-primary">Sign
                    Up</a></div>
        </section>
    </main>
